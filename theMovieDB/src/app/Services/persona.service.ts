...
import { Detalles, Persona, PersonaResponse } from '../Interfaces/personas-response.interface';
...
export class PersonaService {
  ...
  public getActor(idActor: string): Observable<Detalles> {
    return this.http.get<Detalles>(
      URL_BASE + "/popular?api_key=" +API_KEY
    );
  }
}
